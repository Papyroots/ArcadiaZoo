...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO opinion (name_visitor, opinion, is_visible, created_at) VALUES (:name_visitor, :opinion, :is_visible, :created_at)");

        // Liaison des paramètres
        $stmt->bindValue(':name_visitor', $opinion->getNameVisitor());
        $stmt->bindValue(':opinion', $opinion->getOpinion());
